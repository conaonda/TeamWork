...
2. 에이전트 역할(Orchestrator, Developer, Reviewer, Tester, Researcher, Documenter)을 할당합니다.
...
```bash
# 3회 스프린트 자동 실행
/path/to/TeamWork/scripts/sprint.sh --repo owner/my-app --workdir ~/git --sprints 3
```
